...
${OBJECTDIR}/abm.o: abm.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/abm.o abm.c

${OBJECTDIR}/coeffs.o: coeffs.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coeffs.o coeffs.c

${OBJECTDIR}/poly.o: poly.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/poly.o poly.c
